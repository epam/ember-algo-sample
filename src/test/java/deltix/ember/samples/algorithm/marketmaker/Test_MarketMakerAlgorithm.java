...
import deltix.ember.message.trade.oms.MutablePositionReport;
...
public class Test_MarketMakerAlgorithm extends SingleLegExecutionAlgoUnitTest<MarketMakerAlgorithm> {
    ...
    // isFound false, as there are no active orders before reboot
    void simulatePositionReport() {
        MutablePositionReport response = new MutablePositionReport();
        response.setError(null);
        response.setFound(false);

        this.algorithmMock.onPositionReport(response);
    }
